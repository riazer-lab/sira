...
<Callout type="info">Color BW `bw` means a palette from Black to White.</Callout>
...
<Callout type="info">
  Actually Sira will calculate the color value you give (mainly use hue & sat) to generate a palette automatically.
</Callout>
