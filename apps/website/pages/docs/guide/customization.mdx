...
<Callout type="info">Use Sira will apply some base layer style on your site automatically.</Callout>
...
<Callout type="info">Try to toggle color scheme options on the bottom of page to see what will happen.</Callout>
...
<div className="grid grid-cols-2 xl:grid-cols-5 gap-4 p-4 has-border rounded-xl">
  ...
  <div className="grid gap-4">
    ...
    <div className="p-4 rounded-lg bg-info-500 text-bw-50">info-500</div>
    <div className="p-4 rounded-lg bg-info-600 text-bw-50">info-600</div>
    <div className="p-4 rounded-lg bg-info-700 text-bw-50">info-700</div>
...
<Callout type="info">
  Color BW `bw` means a palette from Black to White (or white to black, depending on color schema), the difference from
...
<Callout type="info">
  Actually Sira will calculate the color value you give (mainly use hue & sat) to generate a palette to satisfy Radix
  color reference automatically.
</Callout>
