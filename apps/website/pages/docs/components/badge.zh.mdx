...
<CodeDemo>
  <div className="grid gap-4">
    <div className="badge solid success xs">尺寸-xs</div>
    <div className="badge solid warn sm">尺寸-sm</div>
    <div className="badge solid info md">尺寸-md</div>
    <div className="badge solid danger lg">尺寸-lg</div>
    <div className="badge solid success xl">尺寸-xl</div>
  </div>
</CodeDemo>
...
<ClassNameTable component="badge" />
