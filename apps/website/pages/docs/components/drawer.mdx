...
```html
<div>
  <label class="btn solid success w-fit" onclick="toggleDrawer('left')"
    >Open left</label
  >
  ...
  <div class="drawer left" id="drawer-left">
    <div class="content flex flex-col h-full">
      <label
        class="btn sm circle ghost absolute right-2 top-2"
...
```html
<div>
  <label class="btn solid success w-fit" onclick="toggleDrawer('right')"
    >Open right</label
  >
...
```html
<div>
  <label class="btn solid success w-fit" onclick="toggleDrawer('top')"
    >Open top</label
  >
...
```html
<div>
  <label class="btn solid success w-fit" onclick="toggleDrawer('bottom')"
    >Open bottom</label
  >
...
<div>
  <label
    class="btn solid danger w-fit only-one-line"
    onclick="toggleDrawer('toggle-overlay-click-not-close')"
...
<DrawerDemo
  position={"left"}
  labelText={"Overlay click not close"}
...
<div>
  <label
    class="btn solid danger w-fit only-one-line"
    onclick="toggleDrawer('no-overlay')"
    >No overlay</label
  >
...
<div>
  <label
    class="btn solid danger w-fit only-one-line"
    onclick="toggleDrawer('pause-scroll')"
    >Pause Scroll</label
  >
...
<DrawerDemo
  position={"left"}
  labelText={"Pause Scroll"}
  pauseScroll={true}
  content={"Try to scroll the page 🦎"}
/>
