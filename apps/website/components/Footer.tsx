    ...
    <footer className="bg-transparent">
      <div className="grid grid-cols-4 gap-10 place-items-stretch">
        <div className="col-span-2 flex flex-col gap-3">
          ...
          <p className="text-xs">
            Powered by <Link href={"https://www.riccox.com"}>Ricco Xie</Link>.
            All rights reserved. Copyright © Since 2023
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <ul className="flex flex-col gap-4 text-xs text-bw-1000/80">
            ...
            <li>
              <Link
                href="https://github.com/riccox/sira/issues/new"
                target="_blank"
              >
                Report issue
              </Link>
            ...
            <li>
              <Link
                href="https://github.com/riccox/sira/blob/main/LICENSE"
                target={"_blank"}
              >
                License
              </Link>
