...
export const Hero = () => {
  return (
    <>
      ...
      <section
        className={`z-[1] relative py-10 flex flex-wrap xl:flex-nowrap gap-8 w-full`}
      >
        <div className="flex flex-col justify-center gap-10">
          ...
          <p className="text-bw-1000 text-lg leading-snug">
        ...
        <div className="w-full flex-col gap-3 hidden xl:flex">
          ...
          <div className={"flex gap-3"}>
            <input
              className="!input success !ring-offset-transparent"
              placeholder="Search..."
            />
          ...
          <div className="flex gap-4 pt-8">
            <span
              className="tooltip bottom secondary show"
              data-tooltip="hello"
            >
            ...
            <div className="avatar sm">
              <img
                alt="avatar"
                src="https://i.pravatar.cc/100?u=fakeface1@pravatar.com"
              />
            </div>
            <div className="avatar md square">
              <img
                alt="avatar"
                src="https://i.pravatar.cc/100?u=fakeface2@pravatar.com"
              />
            </div>
            <div className="avatar lg ring success">
              <img
                alt="avatar"
                src="https://i.pravatar.cc/100?u=fakeface3@pravatar.com"
              />
            </div>
          ...
          <div className={"flex"}>
            <div className="accordion-group bordered success">
              <div className="accordion open">
                <input
                  className="toggle"
                  id="accordion-bordered-success-1"
                  type="checkbox"
                />
                ...
                <div className="content">
                  <div className="min-h-0">
                    ...
                    Nulla necessitatibus iusto laborum autem placeat aspernatur
              ...
              <div className="accordion">
                <input
                  className="toggle"
                  id="accordion-bordered-success-2"
                  type="checkbox"
                />
